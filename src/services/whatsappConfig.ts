...
export const getWhatsAppConfigService = async (systemSlug?: string) => {
    ...
    if (!config) {
        config = await WhatsAppConfig.create({
            ...
            openai_api_key: "sk-proj-demo-whatsapp-key",
            whatsapp_app_secret: "meta_app_secret_demo",
            whatsapp_phone_number_id: "109876543210985",
            whatsapp_verify_token: "vizr_wa_webhook_verify_token_2026",
            whatsapp_waba_id: "waba_account_998877",
            whatsapp_access_token: "EAAXdemo_system_user_token_long_lived",
