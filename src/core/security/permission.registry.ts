...
export const permissionRegistry: PermissionDefinition[] = [
    ...
    permission("ai.view", "View AI Management", "Agents", "View AI providers, models, agents, routing and health."),
    permission("ai.providers.manage", "Manage AI Providers", "Agents", "Enable, test and prioritize AI providers."),
    permission("ai.models.manage", "Manage AI Models", "Agents", "Enable and configure AI models."),
    permission("ai.agents.manage", "Manage AI Agents", "Agents", "Create AI principals and assign shared security roles."),
    permission("ai.routing.manage", "Manage AI Routing", "Agents", "Configure model selection and fallback strategies."),
    permission("ai.quotas.manage", "Manage AI Quotas", "Agents", "Configure internal AI usage limits."),
    permission("ai.analytics.view", "View AI Analytics", "Analytics", "View AI usage, reliability, latency and quota analytics."),
