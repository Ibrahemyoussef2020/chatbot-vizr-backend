...
const schema = new Schema({
    ...
    dashboardBaseline: { requests: { type: Number, min: 0 }, tokens: { type: Number, min: 0 } },
    runtimeInitialized: { type: Boolean, default: false },
    windowId: { type: String },
    leases: [{ _id: false, id: { type: String, required: true }, expiresAt: { type: Date, required: true } }],
}, { timestamps: true });
